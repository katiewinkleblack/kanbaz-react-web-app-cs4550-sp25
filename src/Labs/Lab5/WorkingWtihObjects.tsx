...
export default function WorkingWithObjects() {
  ...
  const [module, setModules] = useState({id: 2, name: "Module 1", 
    description: "Test Module", course: "Aerodynamics"
});
    ...
    <div id="wd-working-with-objects">
      ...
      <FormControl className="w-75" id="wd-assignment-title"
        defaultValue={module.name} onChange={(e) =>
          setModules({ ...module, name: e.target.value })}/>
      <hr />
      ...
      <FormControl className="w-75" id="wd-module-desc"
        defaultValue={module.description} onChange={(e) =>
          setModules({ ...module, description: e.target.value })}/>
      <hr />
