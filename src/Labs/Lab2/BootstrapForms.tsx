   ...
   <fieldset>
     <Form.Group as={Row} className="mb-3">
       <Form.Label as="legend" column sm={2}>
         Radios </Form.Label>
       <Col sm={10}>
       <input type="radio" name="radio-genre" id="wd-radio-first" />
<label htmlFor="wd-radio-first">First Radio</label><br />

<input type="radio" name="radio-genre" id="wd-radio-second" />
<label htmlFor="wd-radio-second">Second Radio</label><br />

<input type="radio" name="radio-genre" id="wd-radio-third" />
<label htmlFor="wd-radio-third">Third Radio</label><br />
